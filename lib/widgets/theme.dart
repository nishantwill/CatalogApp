...
class MyTheme {
  static ThemeData lightTheme(BuildContext context) => ThemeData(
    ...
    ), colorScheme: ColorScheme.fromSwatch(primarySwatch: Colors.indigo).copyWith(secondary: blueish),
  );
  static ThemeData darkTheme(BuildContext context) => ThemeData(
    ...
    appBarTheme: AppBarTheme(
      color: Colors.black,
      elevation: 0.0,
      iconTheme: IconThemeData(color: Colors.indigoAccent), toolbarTextStyle: Theme.of(context).textTheme.bodyText2, titleTextStyle: Theme.of(context).textTheme.headline6,
